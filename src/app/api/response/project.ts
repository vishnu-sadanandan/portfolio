export const project = [
  {
    ...
    challengesFaced: [
      "DSA",
      "Integrating Looker Dashboards",
      "Personalizing Looker Dashboards",
    ],
  ...
  },
  {
    ...
    description:
      "An open-source React-based user interface for IBM Watson Discovery service, designed to provide an interactive platform for exploring and visualizing data stored in Watson Discovery.",
  ...
  },
  {
    ...
    description:
      "A web application developed for airline crews to view terminal maps and essential flight data. The app uses Mapbox GL to render flight information and terminal locations in real time, providing an interactive map experience for efficient crew operations.",
    hostedlink: "https://example.com/terminal-map-viewer",
    githubrepository:
      "https://github.com/yourusername/airline-terminal-map-viewer",
    skill: [
      "Mapbox GL",
      "JavaScript",
      "React.js",
  ...
  },
  {
    ...
    description:
      "A web-based platform developed for small and medium-sized businesses to manage operations more efficiently. Integrated a video call facility using React.js and Mediasoup, enabling seamless real-time communication for businesses.",
  ...
  },
  {
    ...
    name: "Inout Adserver",
    description:
      "Worked on multiple small-scale applications including ad servers and real estate platforms, utilizing JavaScript, PHP, and MySQL. Developed features, improved performance, and ensured smooth functionality for various web applications.",
    hostedlink: "https://www.inoutscripts.com/",
    githubrepository: "https://github.com/yourusername/inoutscripts-projects",
    skill: ["JavaScript", "PHP", "MySQL", "HTML", "CSS"],
    projectType: "Work",
    challengesFaced: [
